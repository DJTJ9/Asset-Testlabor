...
public static class Setup {
    ...
    public static void CreateDefaultFolders() {
        Folders.CreateDefault("_Project", "Animation", "Art", "Materials", "MyTools", "Prefabs", "Scenes", "ScriptableObjects", "ScriptableObjects/ScriptableValues", "Scripts", "Scripts/ScriptableObjects", "Settings", "{------------------}");
        Refresh();
    }
