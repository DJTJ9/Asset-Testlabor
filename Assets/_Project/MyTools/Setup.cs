...
public static class Setup {
    ...
    public static void CreateDefaultFolders() {
        Folders.CreateDefault("_Project", "Animation", "Art", "Materials", "MyTools", "Prefabs", "Shader", "Shader/SubGraphs", "Scenes", "ScriptableObjects", "ScriptableObjects/ScriptableValues", "Scripts", "Scripts/ScriptableObjects", "Settings", "{------------------}");
        Refresh();
    }
